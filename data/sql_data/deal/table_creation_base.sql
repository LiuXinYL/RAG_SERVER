TableName,Comment,SQL
角色表,表示一个智能实体，如人员、算法等,"CREATE TABLE `agent` (
...
角色类型表,如管理者、操作人员、购买者、租佣者等,"CREATE TABLE `agent_role` (
  `org_agent_site` varchar(16) NOT NULL,
  `agent_id` bigint(20) NOT NULL DEFAULT '0',
...
角色关系表,用于定义agent与其他agent间的角色关系。如租赁关系、雇主关系、买卖关系等,"CREATE TABLE `agent_role_with_agent` (
  `org_agent_site` varchar(16) NOT NULL,
  `agent_id` bigint(20) NOT NULL DEFAULT '0',
  `ag_role_db_site` varchar(16) NOT NULL,
  `ag_role_db_id` bigint(20) NOT NULL DEFAULT '0',
...
智能个体类型表,,"CREATE TABLE `agent_type` (
  `agent_db_site` varchar(16) NOT NULL,
  `agent_db_id` bigint(20) NOT NULL DEFAULT '0',
  `agent_type_code` bigint(20) NOT NULL DEFAULT '0',
  `user_tag_ident` varchar(254) DEFAULT NULL,
...
设备表,系统表和设备表一一对应，查询某个系统下的设备信息时需要先去segemnt_child中找到对应的子系统，然后再查询设备表，输出设备信息,"CREATE TABLE `asset` (
...
设备二进制数据表,,"CREATE TABLE `asset_blob_data` (
...
设备字符数据表,,"CREATE TABLE `asset_chr_data` (
  `asset_org_site` varchar(16) NOT NULL,
  `asset_id` bigint(20) NOT NULL DEFAULT '0',
...
设备数值数据表,,"CREATE TABLE `asset_num_data` (
  `asset_org_site` varchar(16) NOT NULL,
  `asset_id` bigint(20) NOT NULL DEFAULT '0',
...
系统上安装设备表,用于存储安装在系统上的设备,"CREATE TABLE `asset_on_segment` (
  `asset_org_site` varchar(16) NOT NULL,
  `asset_id` bigint(20) NOT NULL DEFAULT '0',
...
系统二进制数据类型表,,"CREATE TABLE `blob_data_type` (
  `bd_db_site` varchar(16) NOT NULL,
  `bd_db_id` bigint(20) NOT NULL DEFAULT '0',
  `bd_type_code` bigint(20) NOT NULL DEFAULT '0',
  `user_tag_ident` varchar(254) DEFAULT NULL,
...
危害等级表,,"CREATE TABLE `criticality_scale_type` (
...
单位表,,"CREATE TABLE `eng_unit_type` (
  `eu_db_site` varchar(16) NOT NULL,
  `eu_db_id` bigint(20) NOT NULL DEFAULT '0',
  `eu_type_code` bigint(20) NOT NULL DEFAULT '0',
...
组织类型表,,"CREATE TABLE `enterprise_type` (
  `ent_db_site` varchar(16) NOT NULL,
  `ent_db_id` bigint(20) NOT NULL DEFAULT '0',
  `ent_type_code` bigint(20) NOT NULL DEFAULT '0',
  `user_tag_ident` varchar(254) DEFAULT NULL,
...
健康等级表,,"CREATE TABLE `health_level_type` (
...
测试点关联表,,"CREATE TABLE `meas_loc_assoc` (
...
测试点类型表,,"CREATE TABLE `meas_loc_type` (
...
测试点表,,"CREATE TABLE `meas_location` (
  `meas_loc_site` varchar(16) NOT NULL,
  `meas_loc_id` bigint(20) NOT NULL DEFAULT '0',
  `ml_db_site` varchar(16) NOT NULL,
  `ml_db_id` bigint(20) NOT NULL DEFAULT '0',
...
实时二进制数据表,包括振动、图片数据，与测试点表关联查询,"CREATE TABLE `mevent_blob_data` (
  `meas_loc_site` varchar(16) NOT NULL,
  `meas_loc_id` bigint(20) NOT NULL DEFAULT '0',
...
实时字符数据表,与测试点类型表关联查询，若为状态类型，查询此表，与测试点表关联查询,"CREATE TABLE `mevent_chr_data` (
  `meas_loc_site` varchar(16) NOT NULL,
  `meas_loc_id` bigint(20) NOT NULL DEFAULT '0',
  `gmt_event` datetime(3) NOT NULL,
  `eu_db_site` varchar(16) NOT NULL,
...
数值类数据告警表,,"CREATE TABLE `mevent_num_alarm` (
  `meas_loc_site` varchar(16) NOT NULL,
  `meas_loc_id` bigint(20) NOT NULL DEFAULT '0',
  `gmt_event` datetime(3) NOT NULL,
  `eu_db_site` varchar(16) NOT NULL,
...
实时数值数据表,与测试点类型表关联查询，若为非状态类型，查询此表，与测试点表关联查询,"CREATE TABLE `mevent_num_data` (
  `meas_loc_site` varchar(16) NOT NULL,
  `meas_loc_id` bigint(20) NOT NULL DEFAULT '0',
  `gmt_event` datetime(3) NOT NULL,
  `eu_db_site` varchar(16) NOT NULL,
...
告警事件与关联的告警配置信息表,,"CREATE TABLE `num_al_assoc_reg` (
  `meas_loc_site` varchar(16) NOT NULL,
  `meas_loc_id` bigint(20) NOT NULL DEFAULT '0',
  `gmt_event` datetime(3) NOT NULL,
  `eu_db_site` varchar(16) NOT NULL,
...
实数型数据告警配置表,实数型数据的告警配置信息。包括上下限、单位、告警类型等信息,"CREATE TABLE `num_alarm_reg` (
  `alarm_db_site` varchar(16) NOT NULL,
  `alarm_db_id` bigint(20) NOT NULL DEFAULT '0',
  `meas_loc_site` varchar(16) NOT NULL,
  `meas_loc_id` bigint(20) NOT NULL DEFAULT '0',
...
优先级表,,"CREATE TABLE `priority_level_type` (
...
行数据类型表,,"CREATE TABLE `row_status_type` (
...
系统表,记录所有系统信息和设备信息,"CREATE TABLE `segment` (
  `segment_site` varchar(16) NOT NULL,
  `segment_id` bigint(20) NOT NULL DEFAULT '0',
...
系统二进制数据表,,"CREATE TABLE `segment_blob_data` (
  `db_site` varchar(16) NOT NULL,
  `db_id` bigint(20) NOT NULL DEFAULT '0',
  `segment_site` varchar(16) NOT NULL,
  `segment_id` bigint(20) NOT NULL DEFAULT '0',
...
系统和子系统关系表,记录系统表中的父子关系，子系统信息去系统表中查询,"CREATE TABLE `segment_child` (
  `segment_site` varchar(16) NOT NULL,
  `segment_id` bigint(20) NOT NULL DEFAULT '0',
...
系统字符数据表,,"CREATE TABLE `segment_chr_data` (
  `segment_site` varchar(16) NOT NULL,
  `segment_id` bigint(20) NOT NULL DEFAULT '0',
...
事件表,,"CREATE TABLE `segment_event` (
  `segment_site` varchar(16) NOT NULL,
  `segment_id` bigint(20) NOT NULL DEFAULT '0',
...
故障模式功能表,,"CREATE TABLE `segment_function` (
  `db_site` varchar(16) NOT NULL,
  `db_id` bigint(20) NOT NULL DEFAULT '0',
  `segment_site` varchar(16) NOT NULL,
  `segment_id` bigint(20) NOT NULL DEFAULT '0',
...
健康评估表,,"CREATE TABLE `segment_health` (
  `segment_site` varchar(16) NOT NULL,
  `segment_id` bigint(20) NOT NULL DEFAULT '0',
...
系统数据表,,"CREATE TABLE `segment_num_data` (
  `segment_site` varchar(16) NOT NULL,
  `segment_id` bigint(20) NOT NULL DEFAULT '0',
...
系统类型表,,"CREATE TABLE `segment_type` (
  `sg_db_site` varchar(16) NOT NULL,
  `sg_db_id` bigint(20) NOT NULL DEFAULT '0',
  `sg_type_code` bigint(20) NOT NULL DEFAULT '0',
  `user_tag_ident` varchar(254) DEFAULT NULL,
...
事件类型表,,"CREATE TABLE `sg_as_event_type` (
  `ev_db_site` varchar(16) NOT NULL,
  `ev_db_id` bigint(20) NOT NULL DEFAULT '0',
  `event_type_code` bigint(20) NOT NULL DEFAULT '0',
  `user_tag_ident` varchar(254) DEFAULT NULL,
...
系统字符数据类型表,,"CREATE TABLE `sg_chr_dat_type` (
  `sc_db_site` varchar(16) NOT NULL,
  `sc_db_id` bigint(20) NOT NULL DEFAULT '0',
  `sc_type_code` bigint(20) NOT NULL DEFAULT '0',
  `user_tag_ident` varchar(254) DEFAULT NULL,
...
实时维修维护数据表,,"CREATE TABLE `sg_completed_work` (
  `segment_site` varchar(16) NOT NULL,
  `segment_id` bigint(20) NOT NULL DEFAULT '0',
...
模糊组与故障模式关联表,,"CREATE TABLE `sg_hyp_ev_log_conn` (
...
故障率表,,"CREATE TABLE `sg_hyp_ev_num_data` (
...
故障模式与功能关联表,,"CREATE TABLE `sg_hyp_ev_sg_func` (
  `sg_hyp_db_site` varchar(16) NOT NULL,
  `sg_hyp_db_id` bigint(20) NOT NULL DEFAULT '0',
  `sg_hyp_event_id` bigint(20) NOT NULL DEFAULT '0',
  `db_site` varchar(16) NOT NULL,
...
故障模式表,存储某个系统或设备所有的故障模式,"CREATE TABLE `sg_hyp_event` (
  `sg_hyp_db_site` varchar(16) NOT NULL,
  `sg_hyp_db_id` bigint(20) NOT NULL DEFAULT '0',
  `sg_hyp_event_id` bigint(20) NOT NULL DEFAULT '0',
  `segment_site` varchar(16) NOT NULL,
...
系统数值数据类型表,,"CREATE TABLE `sg_num_dat_type` (
  `sn_db_site` varchar(16) NOT NULL,
  `sn_db_id` bigint(20) NOT NULL DEFAULT '0',
  `sn_type_code` bigint(20) NOT NULL DEFAULT '0',
  `user_tag_ident` varchar(254) DEFAULT NULL,
...
故障表,查询故障系统或设备步骤，关联sg_hyp_ev_amb_set表查找对应的sg_hyp_amb_set_id，关联sg_hyp_ev_log_conn表查找对应的sg_hyp_event_id，关联sg_hyp_event查找对应的segment_site，segment_id，关联segment表查找故障系统或设备,"CREATE TABLE `sg_pr_ev_amb_set_sg_ev` (
...
维修建议表,,"CREATE TABLE `sg_recommendation` (
  `segment_site` varchar(16) NOT NULL,
  `segment_id` bigint(20) NOT NULL DEFAULT '0',
...
工作管理表,"系统或设备的维修项或维护项,查找系统或设备的维护信息，有关联segment,查找segment_site和segment_id，关联work_manage_type，查找name为维护保养的wm_type_code,查找sg_req_for_work中对应wm_type_code的所有wm_type_code,关联work_request表，查找name","CREATE TABLE `sg_req_for_work` (
...
站点表,表示办公楼、飞机、生产基地、车辆、武器装备、坦克、飞艇,"CREATE TABLE `site` (
...
维护项,,"CREATE TABLE `solution_package` (
...
维护项二进制数据表,,"CREATE TABLE `solution_package_blob_data` (
  `sol_pack_db_site` varchar(16) NOT NULL,
  `sol_pack_db_id` bigint(20) NOT NULL DEFAULT '0',
  `sol_pack_id` bigint(20) NOT NULL DEFAULT '0',
  `bd_db_site` varchar(16) NOT NULL,
...
维护项字符数据表,,"CREATE TABLE `solution_package_chr_data` (
  `sol_pack_db_site` varchar(16) NOT NULL,
  `sol_pack_db_id` bigint(20) NOT NULL DEFAULT '0',
  `sol_pack_id` bigint(20) NOT NULL DEFAULT '0',
...
维护项数值数据表,,"CREATE TABLE `solution_package_num_data` (
  `sol_pack_db_site` varchar(16) NOT NULL,
  `sol_pack_db_id` bigint(20) NOT NULL DEFAULT '0',
  `sol_pack_id` bigint(20) NOT NULL DEFAULT '0',
...
维护步骤,,"CREATE TABLE `solution_package_step` (
...
维护步骤字符数据表,,"CREATE TABLE `solution_package_step_chr_data` (
  `sol_pack_step_db_site` varchar(16) NOT NULL,
  `sol_pack_step_db_id` bigint(20) NOT NULL DEFAULT '0',
  `sol_pack_step_id` bigint(20) NOT NULL DEFAULT '0',
  `wc_db_site` varchar(16) NOT NULL,
...
维护步骤数值数据表,,"CREATE TABLE `solution_package_step_num_data` (
  `sol_pack_step_db_site` varchar(16) NOT NULL,
  `sol_pack_step_db_id` bigint(20) NOT NULL DEFAULT '0',
  `sol_pack_step_id` bigint(20) NOT NULL DEFAULT '0',
  `wn_db_site` varchar(16) NOT NULL,
...
工作管理类型表,,"CREATE TABLE `work_manage_type` (
  `wm_type_db_site` varchar(16) NOT NULL,
  `wm_type_db_id` bigint(20) NOT NULL DEFAULT '0',
  `wm_type_code` bigint(20) NOT NULL DEFAULT '0',
...
维护保养信息表,,"CREATE TABLE `work_request` (
...
任务类型表,,"CREATE TABLE `work_task_type` (
  `task_db_site` varchar(16) NOT NULL,
  `task_db_id` bigint(20) NOT NULL DEFAULT '0',
  `task_type_code` bigint(20) NOT NULL DEFAULT '0',

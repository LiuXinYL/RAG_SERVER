...
/* >>>------------------------------------------------------------
 *
 * File: MC25CM_Rule-1.1-C99.c
 *
 * MISRA Required - C99 Specific Rules
 *
 * Rule-1.1-C99: The program shall contain no violations of the standard C syntax
...
extern void Rule_0101_C99 (void)
{
  {
  ...
  {
    extern void Rule_0101_C99_Declared (void);

    Rule_0101_C99_Declared ();                             // expect: !3335

    Rule_0101_C99_Undeclared ();                           // expect: 3335
  }
}
